 ...
 * @author semih
 */
public class frmCostumerList extends javax.swing.JInternalFrame {
    ...
    private void setListIcon() {
        tblList.setModel(new DefaultTableModel(new Object[][]{}, new String[]{"Müşteri ID", "Adı", "Vergi Dairesi", "Ticari Sicil No", "Telefon Numarası", "Mail", "Fax", "Yetkili Adı", "Tetkili Ünvanı", "Yetkili Departmanı", "Yetkili Telefon No", "Yetkili Mail", "Yetkili Fax", "Ülke", "Şehir", "İlçe", "Mahalle", "Adres"}));
    ...
    private void refresh() {
        sCostumer.getTableList(tblList);
    }

    private void search(String name) {
        sCostumer.getTableSearchList(tblList, name);
    }
